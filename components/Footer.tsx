...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-[#0e0e0d] pb-[calc(1rem+var(--sticky-bar-offset,0px))] md:pb-[calc(1.25rem+var(--sticky-bar-offset,0px))]">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-14 md:grid-cols-2 md:px-12 lg:grid-cols-4">
        <div className="md:col-span-2 lg:col-span-1">
          ...
          />
          <p className="font-body-strong mt-4 max-w-sm text-sm">

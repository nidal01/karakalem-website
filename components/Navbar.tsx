...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full border-b border-white/[0.06] bg-background/75 pt-[env(safe-area-inset-top,0px)] backdrop-blur-xl">
      ...
      <div
        id="mobile-menu"
        className={`fixed inset-x-0 top-[var(--navbar-h)] z-40 border-t border-white/5 bg-background/98 px-6 py-6 backdrop-blur-xl transition md:hidden ${
          open ? "block" : "hidden"
        }`}
      >
